    ...
    <section id="projects" className="projects">
      ...
      <div className="project-list">
        ...
        <div className="project-item">
          ...
          <h4><a href="https://green-bot-site.vercel.app/">Live link</a></h4>
        </div>
        ...
        <div className="project-item">
          ...
          <h4><a href="https://weather-app-omega-kohl-49.vercel.app/">Live link</a></h4>
        </div>
        <div className="project-item">
          <h3>Health Mate</h3>
          ...
          <h4><a href="https://health-mate-psi.vercel.app/">Live link</a></h4>
        </div>
      </div>
    </section>
  );
